    ...
    <Drawer>
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            <DrawerTitle>Upload Invoice</DrawerTitle>
            <DrawerDescription>
            ...
            {availablePOs.length > 0 ? (
              <>
                <div className="bg-amber-50 border border-amber-200 rounded-md p-3 mb-4 flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-amber-800 font-medium">Premium Feature Available</p>
                    <p className="text-xs text-amber-700 mt-1">
                      Upgrade to access our invoice editor with PO data auto-fill and structured data generation for seamless integration.
                    </p>
                  </div>
                </div>
