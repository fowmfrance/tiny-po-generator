// Nomenclature NAF rév. 2 (2008), niveau 5 (sous-classes) — 732 codes.
// Source : INSEE, naf2008_liste_n5.xls (donnée publique).
// L'API recherche-entreprises renvoie le code sans libellé → mapping local.
